function [ X Y Z X_domain Y_domain Z_domain T_domain] = test_with_real_locations_adjusted(obj)
...
%     s_time = obj.gss(i).s_time;
    ...
    data = (norm(r-LocR,2))^6*model.TestData(LocR, origin_time, r, t_time, p_time, s_time, alpha, beta, rho, n);
